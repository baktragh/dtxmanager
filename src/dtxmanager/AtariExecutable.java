...
public class AtariExecutable extends AbstractTableModel {
 ...
 /*Looking for values*/
    ...
    Section createMoveBlockSection(int stadr, int source, int target, int length) {
        Section s = new Section(stadr, stadr + moveblock.length - 1, Section.MOVEBLOCK_SECTION);
        ...
        s.data = new int[moveblock.length];
        /*Copy section*/
        for (int i = 0; i < moveblock.length; i++) {
            s.data[i] = moveblock[i];
        }
        /*Komentar*/
...
static int[] moveblock = {
	0x48, 0x98, 0x48, 0x8A, 0x48, 0xA9, 0xFF, 0x85, 0x80, 0xA9, 0xFE, 0x85,
	0x81, 0xA9, 0xEF, 0x85, 0x82, 0xA9, 0xEE, 0x85, 0x83, 0xA9, 0xDF, 0x85,
	0x84, 0xA9, 0xFE, 0x85, 0x85, 0xA0, 0x00, 0xA6, 0x85, 0xF0, 0x0E, 0xB1,
	0x80, 0x91, 0x82, 0xC8, 0xD0, 0xF9, 0xE6, 0x81, 0xE6, 0x83, 0xCA, 0xD0,
	0xF2, 0xC4, 0x84, 0xF0, 0x07, 0xB1, 0x80, 0x91, 0x82, 0xC8, 0xD0, 0xF5,
	0x68, 0xAA, 0x68, 0xA8, 0x68, 0x60
};


    static final int IDX_SRC_LO = 6;
    static final int IDX_SRC_HI = 10;
    static final int IDX_TGT_LO = 14;
    static final int IDX_TGT_HI = 18;
    static final int IDX_LEN_LO = 22;
    static final int IDX_LEN_HI = 26;
